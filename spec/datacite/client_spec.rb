...
RSpec.describe Datacite::Client do
  ...
  describe "#update" do
    ...
    let(:request_body) do
      <<~JSON
        {"data":{"attributes":{"relatedIdentifiers":[{"relatedIdentifier":"https://doi.org/10.xxxx/xxxxx","relatedIdentifierType":"DOI","relationType":"References","resourceTypeGeneral":"Dataset"}]}}}
      JSON
    end
