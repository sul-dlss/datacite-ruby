...
RSpec.describe Datacite::Mapping::FromCocina::Date do
  ...
  let(:mapped_event_instance) { described_class.new(cocina_object:) }
  let(:dates) { mapped_event_instance.call }
  ...
  describe '#build' do
    ...
    describe 'Creation date start: 2020-01-01' do
      let(:cocina) do
        {
          event: [
            {
    ...
    describe 'Creation date end: 2021-01-01' do
      let(:cocina) do
        {
          event: [
            {
    ...
    describe 'Publication date entered as: 2020-01-01, no embargo, provides submitted date' do
      let(:cocina) do
        {
          event: [
            {
